...
int main(void) {
    ...
    std::cout<<" ptr C " << C->rowPtr[0]<<" "<<C->rowPtr[1]<<" "<<C->rowPtr[2]<<" "<<C->rowPtr[3]<<" "<<C->rowPtr[4]<<" "<<C->rowPtr[5]<<" "<<std::endl;

    std::cout<<" ind C " << C->colInd[0]<<" "<<C->colInd[1]<<" "<<C->colInd[2]<<" "<<C->colInd[3]<<" "<<C->colInd[4]<<" "<<C->colInd[5]<<" "<<C->colInd[6]<<" "<<C->colInd[7]<<" "<<
    C->colInd[8]<<" "<<C->colInd[9]<<" "<<C->colInd[10]<<" "<<C->colInd[11]<<" "<<C->colInd[12]<<" "<<C->colInd[13]<<" "<<C->colInd[14]<<" "<< std::endl;
    std::cout<<" val C " << C->val[0]<<" "<<C->val[1]<<" "<<C->val[2]<<" "<<C->val[3]<<" "<<C->val[4]<<" "<<C->val[5]<<" "<<C->val[6]<<" "<<C->val[7]<<" "<<C->val[14]<<" "<< std::endl;
